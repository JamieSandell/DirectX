...
// Property 1: Move the camera along its look vector (running). 'W', 'S'.
// Property 2: Move the camera along its right vector (strafing). 'A', 'D'.
// Property 3: Rotate the camera around its right vector (looking up/down).
//	Move the mouse.
// Property 4: Rotate the camera around the world y-axis (looking left/right).
//	Move the mouse.
// Property 5: Rotate around the camera's up vector (yaw). 'Q', 'E'.
// Property 6: Rotate around the camera's look vector (roll). 'Z', 'C'.
//
