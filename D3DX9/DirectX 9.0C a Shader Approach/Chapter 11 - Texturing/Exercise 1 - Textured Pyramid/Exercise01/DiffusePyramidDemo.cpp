...
void DiffusePyramidDemo::buildVertexBuffer()
{
	...
	HR(gd3dDevice->CreateVertexBuffer(12 * sizeof(VertexPNT), D3DUSAGE_WRITEONLY,
	...
	// front face
	v[0] = VertexPNT(-1.0f, 0.0f, -1.0f, 0.0f, 0.707f, -0.707f, 0.0f, 1.0f);
	v[1] = VertexPNT( 0.0f, 1.0f,  0.0f, 0.0f, 0.707f, -0.707f, 0.0f, 0.0f);
	v[2] = VertexPNT( 1.0f, 0.0f, -1.0f, 0.0f, 0.707f, -0.707f, 1.0f, 1.0f);

	// left face
	v[3] = VertexPNT(-1.0f, 0.0f,  1.0f, -0.707f, 0.707f, 0.0f, 0.0f, 1.0f);
	v[4] = VertexPNT( 0.0f, 1.0f,  0.0f, -0.707f, 0.707f, 0.0f, 0.0f, 0.0f);
	v[5] = VertexPNT(-1.0f, 0.0f, -1.0f, -0.707f, 0.707f, 0.0f, 1.0f, 1.0f);

	// right face
	v[6] = VertexPNT( 1.0f, 0.0f, -1.0f, 0.707f, 0.707f, 0.0f, 0.0f, 1.0f);
	v[7] = VertexPNT( 0.0f, 1.0f,  0.0f, 0.707f, 0.707f, 0.0f, 0.0f, 0.0f);
	v[8] = VertexPNT( 1.0f, 0.0f,  1.0f, 0.707f, 0.707f, 0.0f, 1.0f, 1.0f);

	// back face
	v[9]  = VertexPNT( 1.0f, 0.0f,  1.0f, 0.0f, 0.707f, 0.707f, 1.0f, 1.0f);
	v[10] = VertexPNT( 0.0f, 1.0f,  0.0f, 0.0f, 0.707f, 0.707f, 0.0f, 1.0f);
	v[11] = VertexPNT(-1.0f, 0.0f,  1.0f, 0.0f, 0.707f, 0.707f, 0.0f, 0.0f);
...
void DiffusePyramidDemo::buildFX()
{
	...
	mhWorldInverseTranspose = mFX->GetParameterByName(0, "gWorldInvTrans");
