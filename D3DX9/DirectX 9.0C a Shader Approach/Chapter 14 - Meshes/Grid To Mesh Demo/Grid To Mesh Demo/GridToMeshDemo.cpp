...
// GridToMeshDemo.cpp
//
// Demonstrates creating a custom mesh based upon the grid geometry.
//
// Controls: Use mouse to orbit and zoom; use the 'W' and 'S' keys to 
//           alter the height of the camera.
//=============================================================================

#include "GridToMeshDemo.h"
	...
	PSTR cmdLine, int showCmd)
{
	...
	GridToMeshDemo app(hInstance, "Grid to Mesh Demo", D3DDEVTYPE_HAL, D3DCREATE_HARDWARE_VERTEXPROCESSING);
	gd3dApp = &app;
...
GridToMeshDemo::GridToMeshDemo(HINSTANCE hInstance, std::string winCaption, D3DDEVTYPE devType, DWORD requestedVP)
...
bool GridToMeshDemo::checkDeviceCaps()
{
	D3DCAPS9 caps;
...
void GridToMeshDemo::onLostDevice()
{
	mGfxStats->onLostDevice();
	HR(mFX->OnLostDevice());
}

void GridToMeshDemo::onResetDevice()
{
...
void GridToMeshDemo::updateScene(float dt)
{
	mGfxStats->update(dt);
...
void GridToMeshDemo::buildGeoBuffers()
{
...
void GridToMeshDemo::buildViewMtx()
{
...
void GridToMeshDemo::buildProjMtx()
{
...
void GridToMeshDemo::convertGridToMesh()
{
	std::vector<D3DXVECTOR3> verts;
	std::vector<DWORD> indices;
