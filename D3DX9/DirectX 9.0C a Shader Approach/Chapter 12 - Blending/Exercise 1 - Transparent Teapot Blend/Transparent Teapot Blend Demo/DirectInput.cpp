...
DirectInput::DirectInput(DWORD keyboardCoopFlags, DWORD mouseCoopFlags)
{
	...
	ZeroMemory(mPrevKeyboardState, sizeof(mPrevKeyboardState));
...
void DirectInput::poll()
{
	...
	memcpy_s(mPrevKeyboardState, 256*sizeof(char), mKeyboardState, 256*sizeof(char));
...
{
	return ( ((mKeyboardState[key] & 0x80) == 0) && ((mPrevKeyboardState[key] & 0x80) != 0) );
}
