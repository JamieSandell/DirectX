...
#include "GfxStats.h"
#include "Vertex.h"
#include "MultiPassMultiTextureDemo.h"
	...
	PSTR cmdLine, int showCmd)
{
	...
	MultiTexDemo app(hInstance, "MultiTexture via Multiple Shader Passes Demo", D3DDEVTYPE_HAL, D3DCREATE_HARDWARE_VERTEXPROCESSING);
	gd3dApp = &app;
