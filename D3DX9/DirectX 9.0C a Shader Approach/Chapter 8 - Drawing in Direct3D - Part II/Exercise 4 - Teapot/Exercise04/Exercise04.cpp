	...
	PSTR cmdLine, int showCmd)
{
	...
	Exercise04 app(hInstance, "Exercise04", D3DDEVTYPE_HAL, D3DCREATE_HARDWARE_VERTEXPROCESSING);
	gd3dApp = &app;
	...
	: D3DApp(hInstance, winCaption, devType, requestedVP)
{
	...
	int numTeapotVerts    = mTeapot->GetNumVertices() * 14;
	int numTeapotTris     = mTeapot->GetNumFaces()    * 14;
...
bool Exercise04::checkDeviceCaps()
{
	D3DCAPS9 caps;
...
void Exercise04::onLostDevice()
{
	mGfxStats->onLostDevice();
	HR(mFX->OnLostDevice());
}

void Exercise04::onResetDevice()
{
...
void Exercise04::updateScene(float dt)
{
	mGfxStats->update(dt);
...
void Exercise04::buildGeoBuffers()
{
