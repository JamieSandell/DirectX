//=============================================================================
// AnimationSetsDemo.cpp.
//
// Demonstrates how to switch between different animation sets.
//
// Controls: Use mouse to orbit and zoom; use the 'W' and 'S' keys to 
//           alter the height of the camera.
//			 Use '1', '2', '3', '4' to switch between the different animation
//			 sets.
//=============================================================================

#include <tchar.h>
#include "AnimationSetsDemo.h"
	...
	PSTR cmdLine, int showCmd)
{
	...
	AnimationSetsDemo app(hInstance, "Animation Sets Demo", D3DDEVTYPE_HAL, D3DCREATE_HARDWARE_VERTEXPROCESSING);
	gd3dApp = &app;
...
AnimationSetsDemo::AnimationSetsDemo(HINSTANCE hInstance, std::string winCaption, D3DDEVTYPE devType, DWORD requestedVP)
...
AnimationSetsDemo::~AnimationSetsDemo()
{
	delete mGfxStats;
	delete mSkinnedMesh;
...
bool AnimationSetsDemo::checkDeviceCaps()
{
	D3DCAPS9 caps;
...
void AnimationSetsDemo::onLostDevice()
{
...
void AnimationSetsDemo::onResetDevice()
{
...
void AnimationSetsDemo::updateScene(float dt)
{
	mGfxStats->update(dt);
	...
	if( gDInput->keyDown(DIK_2))
		mSkinnedMesh->setAnimationSet(1);
	if( gDInput->keyDown(DIK_3))
		mSkinnedMesh->setAnimationSet(2);
	if( gDInput->keyDown(DIK_4))
		mSkinnedMesh->setAnimationSet(3);
...
void AnimationSetsDemo::drawScene()
{
...
void AnimationSetsDemo::buildFX()
{
...
void AnimationSetsDemo::buildViewMtx()
{
...
void AnimationSetsDemo::buildProjMtx()
{
...
void AnimationSetsDemo::initFont()
{
