...
struct Light 
{
	...
	D3DXCOLOR diffuseLight;
	D3DXCOLOR specularLight;
};
...
: D3DApp(hInstance, winCaption, devType, requestedVP)
{
	...
	mLights[0].ambientLight = 0.4f*WHITE;
	mLights[0].diffuseLight = WHITE;
	mLights[0].specularLight = WHITE;
	mLights[0].lightPos = D3DXVECTOR3(0.0f, 3.0f, 0.0f);
	mLights[0].attenuation012 = D3DXVECTOR3(0.0f, 0.2f, 0.0f);

	mLights[1].ambientLight = 0.4f*RED;
	mLights[1].diffuseLight = RED;
	mLights[1].specularLight = RED;
	mLights[1].lightPos = D3DXVECTOR3(0.0f, 3.0f, 0.0f);
	mLights[1].attenuation012 = D3DXVECTOR3(0.0f, 0.2f, 0.0f);
...
void PointLightDemo::updateScene(float dt)
{
	...
	mLights[0].lightPos.z = 25.0f*sinf(theta);
	mLights[1].lightPos.z = -25.0f*sinf(theta);
...
void PointLightDemo::drawScene()
{
	...
	//_stprintf(szBuffer, _T("%i"), (sizeof(Light)));
	//MessageBoxA(0, szBuffer, _T("Size Of"), MB_OK);
	HR(mFX->SetRawValue(mhLight, (void *)&mLights, 0, (sizeof(Light))*2));
...
void PointLightDemo::buildFX()
{
	...
	mhLight			 = mFX->GetParameterByName(0, "gLights");
