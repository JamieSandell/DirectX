...
// SmokeDemo.cpp.
//
// Demonstrates a smoke particle system.
//
	...
	PSTR cmdLine, int showCmd)
{
	...
	SmokeDemo app(hInstance, "Smoke Demo", D3DDEVTYPE_HAL, D3DCREATE_HARDWARE_VERTEXPROCESSING);
	gd3dApp = &app;
...
SmokeDemo::SmokeDemo(HINSTANCE hInstance, std::string winCaption, D3DDEVTYPE devType, DWORD requestedVP)
	: D3DApp(hInstance, winCaption, devType, requestedVP)
{
	...
	mPSys = new Smoke("smoke.fx", "SmokeTech", "smoke.dds", 
		D3DXVECTOR3(-8.0f, 1.8f, 0.0f), psysBox, 1000, 0.01f);
...
bool SmokeDemo::checkDeviceCaps()
{
	D3DCAPS9 caps;
...
void SmokeDemo::updateScene(float dt)
{
	mGfxStats->update(dt);
