...
OutputVS FlamethrowerVS(float3 posL    : POSITION0, 
...
float4 FlamethrowerPS(float4 color : COLOR0, float2 tex0 : TEXCOORD0) : COLOR
{
	return color*tex2D(TexS, tex0);
}

technique FlamethrowerTech
{
    pass P0
    {
        vertexShader = compile vs_2_0 FlamethrowerVS();
        pixelShader  = compile ps_2_0 FlamethrowerPS();
