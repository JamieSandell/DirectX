...
struct VertexPNTBillboard
{
	VertexPNTBillboard()
		:pos(0.0f, 0.0f, 0.0f),
		normal(0.0f, 0.0f, 0.0f),
		bbOffset(0.0f, 0.0f, 0.0f),
		tex0(0.0f, 0.0){}
	VertexPNTBillboard(float x, float y, float z,
		float nx, float ny, float nz,
		float bbX, float bbY, float bbZ,
		float u, float v)
		:pos(x,y,z),
		normal(nx,ny,nz),
		bbOffset(bbX,bbY,bbZ),
		tex0(u,v){}
	VertexPNTBillboard(const D3DXVECTOR3& p, const D3DXVECTOR3& n, const D3DXVECTOR3& b, const D3DXVECTOR2& uv)
		:pos(p),
		normal(n),
		bbOffset(b),
		tex0(uv){}
