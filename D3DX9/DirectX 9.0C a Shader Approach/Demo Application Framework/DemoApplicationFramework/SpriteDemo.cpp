//////////////////////////////////////////////////////////////////////////
//You can modify the z-component of the sprites to change their depth,
//thus making them smaller or bigger. Experiment by changing the depth of
//the ship's position. Also experiment by changing the z-coordinate of pos
...
void SpriteDemo::onResetDevice()
{
	...
	D3DXMATRIX V;
	D3DXVECTOR3 pos(0.0f, 0.0f, -5000.0f);
